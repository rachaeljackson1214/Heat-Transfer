...
while X(10) < 850
    ...
    for i=1:10
        ...
        elseif i == 10 && distance > 1.7
            X(i) = X(i)+(((2*k*dt)/(rho*c*dx^2))*(X(i-1)-X(i)))+((2*ep*sig*dt)/(rho*c*dx))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.1 && distance < 0.3 && i < 3
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.2 && distance < 0.4 && i < 4
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.3 && distance < 0.5 && i < 5
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.4 && distance < 0.6 && i < 6
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.5 && distance < 0.7 && i < 7
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.6 && distance < 0.8 && i < 8
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.7 && distance < 0.9 && i < 9
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 0.8 && distance < 1.0 && i < 10
            X(i) = X(i) + (((k*dt)/(rho*c*dx^2))*(X(i-1)-X(i))) + (((k*dt)/(rho*c*dx^2))*(X(i+1)-X(i))) + ((ep*sig*dt)/(rho*c*dx^2))*(((Xsur)^4)-((X(i)^4)));
        elseif distance > 1.0 || distance == 1.0
            if i == 1
                X(i) = X(i)+(((2*k*dt)/(rho*c*dx^2))*(X(i+1)-X(i)))+((2*ep*sig*dt)/(rho*c*dx))*(((Xsur)^4)-((X(i)^4)));
            elseif i == 10
                X(i) = X(i)+(((2*k*dt)/(rho*c*dx^2))*(X(i-1)-X(i)))+((2*ep*sig*dt)/(rho*c*dx))*(((Xsur)^4)-((X(i)^4)));
